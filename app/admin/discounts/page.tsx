        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        {discountType === 'category' && (
                            <form action={addDiscount} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500 mt-1">Customer must buy this many to get bundle price</p>
                                </div>
                                <div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        <h2 className="text-lg font-bold text-slate-900 mb-4">Active Product Bundles</h2>
                        {categoryDiscounts.length === 0 ? (
                            <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100 text-center">
                                <Tag className="w-12 h-12 text-slate-300 mx-auto mb-3" />
                                <p className="text-slate-500">No active product bundles.</p>
                            </div>
                        ) : (
                                    ...
                                    return (
                                        <div key={discount.id} className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 flex justify-between items-start">
                                            <div className="flex-1">
                                                <p className="text-slate-900 font-bold mb-2">{product?.name || 'Unknown Product'}</p>
                                                ...
                                                <p className="text-xs text-slate-500 mt-1">
                                                    Regular: ₹{product ? (product.price * discount.quantity).toFixed(2) : '—'}
                                                </p>
                                            </div>
