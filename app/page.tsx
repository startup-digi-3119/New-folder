                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative h-[400px] bg-gray-200 rounded-2xl overflow-hidden shadow-xl border-4 border-white">
                            {/* Google Maps Embed */}
                            <iframe
                                src="https://maps.google.com/maps?q=Startup%20Menswear%2C%20140%2C%20141%2F1%2C%20Uppilipalayam%20Main%20Road%2C%20Coimbatore&t=&z=15&ie=UTF8&iwloc=&output=embed"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                allowFullScreen
